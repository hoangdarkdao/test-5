...
Do not give additional explanations.'''
    ...
    @classmethod
    def get_prompt_e1(cls, task_prompt: str, indivs: List[Function], template_function: Function, focus_area: str):
        for indi in indivs:
...
Do not give additional explanations.'''
    ...
    @classmethod
    def get_prompt_e2(cls, task_prompt: str, indivs: List[Function], template_function: Function, focus_area: str):
        for indi in indivs:
            assert hasattr(indi, 'algorithm')
...
I have {len(indivs)} existing algorithms with their codes as follows:
{indivs_prompt}
Please create a new algorithm that has a similar form to the No.{len(indivs)} algorithm and is inspired by the No.{1} algorithm, focusing on {focus_area}.
...
Code:
{str(indi)}
Objective value and runtime: {cls._format_score(indi.score)}\n'
...
Do not give additional explanations.'''
    ...
    @classmethod
    def get_prompt_s1(cls, task_prompt: str, indivs: List[Function], template_function: Function, focus_area: str):
        for indi in indivs:
            assert hasattr(indi, 'algorithm')
...
I have {len(indivs)} existing algorithms with their codes as follows:
{indivs_prompt}
Please help me create a new algorithm that is inspired by all the above algorithms, focusing on {focus_area}.
